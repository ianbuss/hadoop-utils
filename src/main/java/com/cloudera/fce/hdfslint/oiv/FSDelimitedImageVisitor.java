 ...
 * constructor.
 */
public class FSDelimitedImageVisitor extends FSTextWriterImageVisitor {
  ...
  public FSDelimitedImageVisitor(FileSystem fs, String filename) throws IOException {
    this(fs, filename, false);
  }

  public FSDelimitedImageVisitor(FileSystem fs, String outputFile, boolean printToScreen)
                                                           throws IOException {
    this(fs, outputFile, printToScreen, defaultDelimiter);
  }

  public FSDelimitedImageVisitor(FileSystem fs, String outputFile, boolean printToScreen,
                                 String delimiter) throws IOException {
    super(fs, outputFile, printToScreen);
