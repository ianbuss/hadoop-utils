 ...
 */
package com.cloudera.fce.hdfslint.oiv;
 ...
 */
abstract class FSTextWriterImageVisitor extends ImageVisitor {
   ...
   */
  public FSTextWriterImageVisitor(FileSystem fs, String filename) throws IOException {
   ...
   */
  public FSTextWriterImageVisitor(FileSystem fs, String filename, boolean printToScreen)
         throws IOException {
    super();
    this.printToScreen = printToScreen;
    FSDataOutputStream dos = fs.create(new Path(filename));
    fw = new OutputStreamWriter(dos, Charsets.UTF_8);
    okToWrite = true;
  }
